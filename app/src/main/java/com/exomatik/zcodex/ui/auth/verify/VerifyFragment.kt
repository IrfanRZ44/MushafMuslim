package com.exomatik.zcodex.ui.auth.verify
...
import com.exomatik.zcodex.databinding.FragmentVerifyBinding
...
class VerifyFragment : BaseFragmentBind<FragmentVerifyBinding>(){
    override fun getLayoutResource(): Int = R.layout.fragment_verify
    lateinit var viewModel: VerifyViewModel

    override fun myCodeHere() {
        bind.lifecycleOwner = this
        try {
            viewModel = VerifyViewModel(savedData, activity
                , bind.progressTimer, bind.etText1, bind.etText2, bind.etText3, bind.etText4, bind.etText5
                , bind.etText6, findNavController())
    ...
    private fun setProgress() {
        bind.progressTimer.setCircularTimerListener(object :
            TListener {

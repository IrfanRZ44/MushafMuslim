package com.exomatik.zcodex.ui.auth.verifyRegister
...
import com.exomatik.zcodex.databinding.FragmentVerifyRegisterBinding
...
class VerifyRegisterFragment : BaseFragmentBind<FragmentVerifyRegisterBinding>(){
    ...
    override fun myCodeHere() {
        ...
        try {
            ...
            registerViewModel.loading.value = true
            bind.viewModel = registerViewModel
        }catch (e: Exception){
    ...
    private fun setProgress() {
        bind.progressTimer.setCircularTimerListener(object :
            ...
            override fun onTimerFinished() {
                ...
                registerViewModel.isShowLoading.value = false
                registerViewModel.loading.value = false
            }
        ...
        bind.etText6.addTextChangedListener(object : TextWatcher{
            override fun afterTextChanged(s: Editable?) {
                ...
                if (text1.isNotEmpty() && text2.isNotEmpty() && text3.isNotEmpty() &&
                    ...
                    registerViewModel.phoneCode.value = bind.etText1.text.toString() + bind.etText2.text.toString() +
                            bind.etText3.text.toString() + bind.etText4.text.toString() +
                            bind.etText5.text.toString() + bind.etText6.text.toString()
                    registerViewModel.onClick(2)
                }

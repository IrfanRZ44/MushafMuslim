package id.exomatik.mushafmuslim.services.expandableLayout
...
class ExpandableLayout : LinearLayoutCompat {
    ...
    private fun init(attrs: AttributeSet?) {
        ...
        if (attrs != null) {
            ...
            mExpandDuration = typedArray.getInt(R.styleable.ExpandableLayout_expDuration,
                EXPAND_DURATION
            )
